...
public class BrowserDriver {
    ...
    public static AndroidDriver getBrowserDriver()  {
        ...
        if (appiumDriver == null) {
            ...
            caps.setCapability("chromeDriverExecutable","C:\\Users\\User\\IdeaProjects\\APPIUM_Cucumber\\Driver\\chromedriver.exe");
            /* noReset eger false olursa; her test baslangicinda kullanici datalari(tercihleri) sifirlanir ve uygulama
